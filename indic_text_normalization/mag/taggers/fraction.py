...
MAG_ONE_HALF = "१/२"  # 1/2
MAG_ONE_QUARTER = "१/४"  # 1/4
MAG_THREE_QUARTERS = "३/४"  # 3/4
...
class FractionFst(GraphFst):
    ...
    "२३ ४/६" ->
    fraction { integer: "तेईस" numerator: "चार" denominator: "छ"}
    ४/६" ->
    fraction { numerator: "चार" denominator: "छ"}
    ...
    def __init__(self, cardinal, deterministic: bool = True):
        ...
        dedh_dhai_graph = pynini.string_map(
            [("१" + NEMO_SPACE + MAG_ONE_HALF, MAG_DEDH), ("२" + NEMO_SPACE + MAG_ONE_HALF, MAG_DHAI)]
        )

        savva_numbers = cardinal_graph + pynini.cross(NEMO_SPACE + MAG_ONE_QUARTER, "")
        savva_graph = pynutil.insert(MAG_SAVVA) + pynutil.insert(NEMO_SPACE) + savva_numbers

        sadhe_numbers = cardinal_graph + pynini.cross(NEMO_SPACE + MAG_ONE_HALF, "")
        ...
        paune_numbers = paune + pynini.cross(NEMO_SPACE + MAG_THREE_QUARTERS, "")
