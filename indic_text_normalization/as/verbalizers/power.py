...
class PowerFst(GraphFst):
    ...
    Finite state transducer for verbalizing power, e.g.
        power { base: "দহ" sign: "ঋণাত্মক" exponent: "সাত" } -> দহ পাৱাৰ ঋণাত্মক সাত
        power { base: "দুই" exponent: "তিন" } -> দুই পাৱাৰ তিন
    """
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph = base + pynutil.insert(" পাৱাৰ ") + optional_sign + exponent
