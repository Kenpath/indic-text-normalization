...
from indic_text_normalization.hne.graph_utils import NEMO_NOT_QUOTE, GraphFst, insert_space
...
class ScientificFst(GraphFst):
    ...
    Verbalize scientific-notation tokens, e.g.
      scientific { mantissa: "दस दशमलव एक" exponent: "पाँच" } ->
        दस दशमलव एक गुना दस पावर पाँच

      scientific { mantissa: "दस दशमलव एक" sign: "ऋणात्मक" exponent: "पाँच" } ->
        दस दशमलव एक गुना दस पावर ऋणात्मक पाँच
    """
    ...
    def __init__(self, deterministic: bool = True):
        ...
        graph = mantissa + pynutil.insert(" गुना दस पावर ") + optional_sign + exponent
