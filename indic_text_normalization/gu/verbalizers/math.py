...
from indic_text_normalization.gu.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space, insert_space


class MathFst(GraphFst):
    """
    Finite state transducer for verbalizing math expressions, e.g.
        math { left: "એક" operator: "બરાબર" right: "બે" } -> એક બરાબર બે
        math { left: "એક" operator: "વત્તા" right: "બે" } -> એક વત્તા બે
