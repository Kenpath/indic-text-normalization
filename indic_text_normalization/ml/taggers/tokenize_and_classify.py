...
from indic_text_normalization.ml.taggers.abbreviation import AbbreviationFst
from indic_text_normalization.ml.taggers.cardinal import CardinalFst
from indic_text_normalization.ml.taggers.date import DateFst
from indic_text_normalization.ml.taggers.decimal import DecimalFst
from indic_text_normalization.ml.taggers.electronic import ElectronicFst
from indic_text_normalization.ml.taggers.fraction import FractionFst
from indic_text_normalization.ml.taggers.measure import MeasureFst
from indic_text_normalization.ml.taggers.money import MoneyFst
from indic_text_normalization.ml.taggers.ordinal import OrdinalFst
from indic_text_normalization.ml.taggers.punctuation import PunctuationFst
from indic_text_normalization.ml.taggers.range import RangeFst
from indic_text_normalization.ml.taggers.roman import RomanFst
from indic_text_normalization.ml.taggers.serial import SerialFst
from indic_text_normalization.ml.taggers.telephone import TelephoneFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from indic_text_normalization.ml.taggers.math import MathFst
