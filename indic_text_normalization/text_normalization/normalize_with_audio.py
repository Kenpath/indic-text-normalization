...
from indic_text_normalization.text_normalization.data_loader_utils import post_process_punct, pre_process
from indic_text_normalization.text_normalization.normalize import Normalizer
from indic_text_normalization.text_normalization.utils_audio_based import get_alignment
...
def parse_args():
    ...
    parser.add_argument(
        "--language", help="Select target language", choices=["en", "hi", "kn", "bn", "mr", "bho", "cg", "mag", "mai", "ta", "te", "gu"], default="en", type=str
    )
