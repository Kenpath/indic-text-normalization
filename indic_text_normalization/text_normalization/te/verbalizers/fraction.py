...
from indic_text_normalization.text_normalization.te.graph_utils import MINUS, NEMO_NOT_QUOTE, GraphFst, insert_space


class FractionFst(GraphFst):
    """
    Finite state transducer for verbalizing fraction
        e.g. fraction { integer: "ఇరవై మూడు" numerator: "నాలుగు" denominator: "ఆరు" }-> ఇరవై మూడు నాలుగు బిట్టు ఆరు
        e.g. fraction { numerator: "నాలుగు" denominator: "ఆరు" } -> నాలుగు బిట్టు ఆరు
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        insert_bata = pynutil.insert(" బిట్టు ")
        insert_aur = pynutil.insert(" మరియు ")
        graph_quarter = (
