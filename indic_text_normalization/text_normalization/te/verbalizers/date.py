...
from indic_text_normalization.text_normalization.te.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst, delete_space


class DateFst(GraphFst):
    """
    Finite state transducer for verbalizing date, e.g.
        date { day: "ఒకటి" month: "ఏప్రిల్" year: "రెండు వెయ్యి ఇరవై నాలుగు" } -> "ఒకటి ఏప్రిల్ రెండు వెయ్యి ఇరవై నాలుగు"
        date { month: "ఏప్రిల్" day: "ఒకటి" year: "రెండు వెయ్యి ఇరవై నాలుగు" } -> "ఏప్రిల్ ఒకటి రెండు వెయ్యి ఇరవై నాలుగు"
