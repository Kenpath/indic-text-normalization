...
from indic_text_normalization.text_normalization.te.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space, insert_space


class TimeFst(GraphFst):
    """
    Finite state transducer for verbalizing time, e.g.
        time { hours: "పన్నెండు"  minutes: "పది"  seconds: "పది" } -> పన్నెండు గంటకు పది నిమిషం పది సెకన్
        time { hours: "ఏడు" minutes: "నలభై"" } -> ఏడు గంటకు నలభై నిమిషం
        time { hours: "పది" } -> పది గంట
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        insert_minute = pynutil.insert("నిమిషం")
        insert_second = pynutil.insert("సెకన్")
        insert_bajkar = pynutil.insert("గంటకు")
        insert_baje = pynutil.insert("గంట")
