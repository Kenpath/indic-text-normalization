...
class WordFst(GraphFst):
    ...
    def __init__(self, punctuation: PunctuationFst, deterministic: bool = True):
        ...
        TELUGU_CHAR = pynini.union(
            *[chr(i) for i in range(0x0C00, 0x0C03 + 1)],  # Telugu vowels and consonants
            *[chr(i) for i in range(0x0C05, 0x0C39 + 1)],  # More Telugu characters
            *[chr(i) for i in range(0x0C3E, 0x0C4D + 1)],  # Telugu diacritics
        ).optimize()
