...
from indic_text_normalization.text_normalization.ma.graph_utils import (
    NEMO_SPACE,
    NEMO_WHITE_SPACE,
    GraphFst,
    delete_extra_space,
...
from indic_text_normalization.text_normalization.ma.taggers.abbreviation import AbbreviationFst
from indic_text_normalization.text_normalization.ma.taggers.cardinal import CardinalFst
from indic_text_normalization.text_normalization.ma.taggers.date import DateFst
from indic_text_normalization.text_normalization.ma.taggers.decimal import DecimalFst
from indic_text_normalization.text_normalization.ma.taggers.electronic import ElectronicFst
from indic_text_normalization.text_normalization.ma.taggers.fraction import FractionFst
from indic_text_normalization.text_normalization.ma.taggers.measure import MeasureFst
from indic_text_normalization.text_normalization.ma.taggers.money import MoneyFst
from indic_text_normalization.text_normalization.ma.taggers.ordinal import OrdinalFst
from indic_text_normalization.text_normalization.ma.taggers.punctuation import PunctuationFst
from indic_text_normalization.text_normalization.ma.taggers.range import RangeFst
from indic_text_normalization.text_normalization.ma.taggers.roman import RomanFst
from indic_text_normalization.text_normalization.ma.taggers.serial import SerialFst
from indic_text_normalization.text_normalization.ma.taggers.telephone import TelephoneFst
from indic_text_normalization.text_normalization.ma.taggers.time import TimeFst
from indic_text_normalization.text_normalization.ma.taggers.whitelist import WhiteListFst
from indic_text_normalization.text_normalization.ma.taggers.word import WordFst
from indic_text_normalization.text_normalization.ma.verbalizers.date import DateFst as vDateFst
from indic_text_normalization.text_normalization.ma.verbalizers.ordinal import OrdinalFst as vOrdinalFst
from indic_text_normalization.text_normalization.ma.verbalizers.time import TimeFst as vTimeFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from indic_text_normalization.text_normalization.ma.taggers.math import MathFst
