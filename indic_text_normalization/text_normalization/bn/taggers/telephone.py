...
from indic_text_normalization.text_normalization.bn.graph_utils import GraphFst, NEMO_DIGIT, NEMO_BN_DIGIT, insert_space
...
class TelephoneFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        from indic_text_normalization.text_normalization.bn.graph_utils import NEMO_SPACE
