...
from indic_text_normalization.text_normalization.bn.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst, delete_space


class DateFst(GraphFst):
    """
    Finite state transducer for verbalizing date, e.g.
        date { day: "এক" month: "এপ্রিল" year: "দুই হাজার চব্বিশ" } -> "এক এপ্রিল দুই হাজার চব্বিশ"
        date { month: "এপ্রিল" day: "এক" year: "দুই হাজার চব্বিশ" } -> "এপ্রিল এক দুই হাজার চব্বিশ"
