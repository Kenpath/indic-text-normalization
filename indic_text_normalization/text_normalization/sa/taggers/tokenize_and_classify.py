...
from indic_text_normalization.text_normalization.sa.graph_utils import (
    NEMO_SPACE,
    NEMO_WHITE_SPACE,
    GraphFst,
    delete_extra_space,
...
from indic_text_normalization.text_normalization.sa.taggers.abbreviation import AbbreviationFst
from indic_text_normalization.text_normalization.sa.taggers.cardinal import CardinalFst
from indic_text_normalization.text_normalization.sa.taggers.date import DateFst
from indic_text_normalization.text_normalization.sa.taggers.decimal import DecimalFst
from indic_text_normalization.text_normalization.sa.taggers.electronic import ElectronicFst
from indic_text_normalization.text_normalization.sa.taggers.fraction import FractionFst
from indic_text_normalization.text_normalization.sa.taggers.measure import MeasureFst
from indic_text_normalization.text_normalization.sa.taggers.money import MoneyFst
from indic_text_normalization.text_normalization.sa.taggers.ordinal import OrdinalFst
from indic_text_normalization.text_normalization.sa.taggers.punctuation import PunctuationFst
from indic_text_normalization.text_normalization.sa.taggers.range import RangeFst
from indic_text_normalization.text_normalization.sa.taggers.roman import RomanFst
from indic_text_normalization.text_normalization.sa.taggers.serial import SerialFst
from indic_text_normalization.text_normalization.sa.taggers.telephone import TelephoneFst
from indic_text_normalization.text_normalization.sa.taggers.time import TimeFst
from indic_text_normalization.text_normalization.sa.taggers.whitelist import WhiteListFst
from indic_text_normalization.text_normalization.sa.taggers.word import WordFst
from indic_text_normalization.text_normalization.sa.verbalizers.date import DateFst as vDateFst
from indic_text_normalization.text_normalization.sa.verbalizers.ordinal import OrdinalFst as vOrdinalFst
from indic_text_normalization.text_normalization.sa.verbalizers.time import TimeFst as vTimeFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from indic_text_normalization.text_normalization.sa.taggers.math import MathFst
