...
from indic_text_normalization.text_normalization.bho.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space, insert_space


class TimeFst(GraphFst):
    """
    Finite state transducer for verbalizing time, e.g.
        time { hours: "बारह"  minutes: "दस"  seconds: "दस" } -> बारह बजे दस मिनट दस सेकंड
        time { hours: "सात" minutes: "चालीस" } -> सात बजे चालीस मिनट
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        insert_baje_simple = pynutil.insert("बजे")

        # hour minute second - Format: hours + minutes + "मिनट" + seconds + "सेकंड" + "बजे"
        graph_hms = (
            hour
            + delete_space
            + minute
        ...
        # hour minute - Format: hours + minutes + "मिनट" + "बजे"
        graph_hm = hour + delete_space + minute + delete_space + insert_minute + insert_space + insert_baje

        # hour - Format: hours + "बजे"
        graph_h = hour + delete_space + insert_baje_simple
