...
from indic_text_normalization.text_normalization.bho.graph_utils import MINUS, NEMO_NOT_QUOTE, GraphFst, insert_space
from indic_text_normalization.text_normalization.bho.taggers.decimal import quantities
...
class DecimalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        # Use "दशमलव" (decimal point) like Hindi, not Tamil "புள்ளி"
