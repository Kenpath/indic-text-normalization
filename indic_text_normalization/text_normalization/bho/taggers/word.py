...
class WordFst(GraphFst):
    """
    Finite state transducer for classifying Bhojpuri words.
    ...
    def __init__(self, punctuation: PunctuationFst, deterministic: bool = True):
        ...
        # Define Bhojpuri characters and symbols using pynini.union
        TAMIL_CHAR = pynini.union(
            *[chr(i) for i in range(0x0B80, 0x0BFF + 1)],  # Bhojpuri characters
        ).optimize()
