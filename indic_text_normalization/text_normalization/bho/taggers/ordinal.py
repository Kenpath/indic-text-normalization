...
from indic_text_normalization.text_normalization.bho.utils import get_abs_path


class OrdinalFst(GraphFst):
    """
    Finite state transducer for classifying Bhojpuri ordinals, e.g.
        १०वाँ -> ordinal { integer: "दसवाँ" }
        २१वाँ -> ordinal { integer: "इक्कीसवाँ" }
