...
from indic_text_normalization.text_normalization.gu.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst


class MoneyFst(GraphFst):
    """
    Finite state transducer for verbalizing money, e.g.
        money { integer_part: "બાર" currency_maj: "રૂપિયા" } -> બાર રૂપિયા
        money { integer_part: "બાર" currency_maj: "રૂપિયા" fractional_part: "પચાસ" currency_min: "centiles" } -> બાર રૂપિયા પચાસ પૈસા
        money { currency_maj: "રૂપિયા" integer_part: "શૂન્ય" fractional_part: "પચાસ" currency_min: "centiles" } -> પચાસ પૈસા
    ...
    def __init__(self):
        ...
        for major, minor in major_minor_currencies.items():
            ...
            graph_minor_partial = (
                pynutil.delete('integer_part: "શૂન્ય"')
