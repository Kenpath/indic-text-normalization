...
from indic_text_normalization.text_normalization.gu.graph_utils import NEMO_CHAR, NEMO_SIGMA, GraphFst, delete_space


class WordFst(GraphFst):
    """
    Finite state transducer for verbalizing Gujarati words.
        e.g. tokens { name: "ગુજરાતી" } -> ગુજરાતી
