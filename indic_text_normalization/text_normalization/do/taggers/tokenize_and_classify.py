...
from indic_text_normalization.text_normalization.do.graph_utils import (
    NEMO_SPACE,
    NEMO_WHITE_SPACE,
    GraphFst,
    delete_extra_space,
...
from indic_text_normalization.text_normalization.do.taggers.abbreviation import AbbreviationFst
from indic_text_normalization.text_normalization.do.taggers.cardinal import CardinalFst
from indic_text_normalization.text_normalization.do.taggers.date import DateFst
from indic_text_normalization.text_normalization.do.taggers.decimal import DecimalFst
from indic_text_normalization.text_normalization.do.taggers.electronic import ElectronicFst
from indic_text_normalization.text_normalization.do.taggers.fraction import FractionFst
from indic_text_normalization.text_normalization.do.taggers.measure import MeasureFst
from indic_text_normalization.text_normalization.do.taggers.money import MoneyFst
from indic_text_normalization.text_normalization.do.taggers.ordinal import OrdinalFst
from indic_text_normalization.text_normalization.do.taggers.punctuation import PunctuationFst
from indic_text_normalization.text_normalization.do.taggers.range import RangeFst
from indic_text_normalization.text_normalization.do.taggers.roman import RomanFst
from indic_text_normalization.text_normalization.do.taggers.serial import SerialFst
from indic_text_normalization.text_normalization.do.taggers.telephone import TelephoneFst
from indic_text_normalization.text_normalization.do.taggers.time import TimeFst
from indic_text_normalization.text_normalization.do.taggers.whitelist import WhiteListFst
from indic_text_normalization.text_normalization.do.taggers.word import WordFst
from indic_text_normalization.text_normalization.do.verbalizers.date import DateFst as vDateFst
from indic_text_normalization.text_normalization.do.verbalizers.ordinal import OrdinalFst as vOrdinalFst
from indic_text_normalization.text_normalization.do.verbalizers.time import TimeFst as vTimeFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from indic_text_normalization.text_normalization.do.taggers.math import MathFst
