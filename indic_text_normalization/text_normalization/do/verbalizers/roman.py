...
from indic_text_normalization.text_normalization.do.graph_utils import NEMO_NOT_QUOTE, GraphFst
from indic_text_normalization.text_normalization.do.utils import get_abs_path
...
class RomanFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True):
        ...
        try:
            ...
            from indic_text_normalization.text_normalization.do.graph_utils import NEMO_SIGMA
