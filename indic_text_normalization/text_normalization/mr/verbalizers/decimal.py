...
class DecimalFst(GraphFst):
    ...
    Finite state transducer for classifying decimal, e.g.
        decimal { negative: "true" integer_part: "बारा"  fractional_part: "पाच शून्य शून्य सहा" quantity: "अब्ज" } -> ऋणात्मक बारा दशमलव पाच शून्य शून्य सहा
        decimal { integer_part: "बारा" quantity: "billion" } -> बारा अब्ज
