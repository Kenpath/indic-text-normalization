...
class DateFst(GraphFst):
    ...
    Finite state transducer for classifying date, e.g.
        "०१-०४-२०२४" -> date { day: "एक" month: "एप्रिल" year: "दोन हजार चोवीस" }
        "०४-०१-२०२४" -> date { month: "एप्रिल" day: "एक" year: "दोन हजार चोवीस" }
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        graph_year_thousands = pynini.compose(
            (NEMO_MR_DIGIT + NEMO_MR_ZERO + NEMO_MR_DIGIT + NEMO_MR_DIGIT), cardinal.graph_thousands
        )
        graph_year_hundreds_as_thousands = pynini.compose(
            (NEMO_MR_DIGIT + NEMO_MR_NON_ZERO + NEMO_MR_DIGIT + NEMO_MR_DIGIT), cardinal.graph_hundreds_as_thousand
        )
        ...
        range_graph = pynini.cross("-", "पासून")

        # Graph for year
        century_number = pynini.compose(pynini.closure(NEMO_MR_DIGIT, 1), cardinal_graph) + pynini.accep("वी")
