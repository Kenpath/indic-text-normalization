...
def get_quantity(decimal: 'pynini.FstLike', cardinal_up_to_hundred: 'pynini.FstLike') -> 'pynini.FstLike':
    ...
    e.g. १.५ लाख -> integer_part: "एक" fractional_part: "पाच" quantity: "लाख"
...
class DecimalFst(GraphFst):
    ...
    Finite state transducer for classifying decimal, e.g.
        -१२.५००६ अब्ज -> decimal { negative: "true" integer_part: "बारा"  fractional_part: "पाच शून्य शून्य सहा" quantity: "अब्ज" }
        १ अब्ज -> decimal { integer_part: "एक" quantity: "अब्ज" }
