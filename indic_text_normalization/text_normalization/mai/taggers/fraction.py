...
MAI_ONE_HALF = "१/२"  # 1/2
MAI_ONE_QUARTER = "१/४"  # 1/4
MAI_THREE_QUARTERS = "३/४"  # 3/4
...
class FractionFst(GraphFst):
    ...
    def __init__(self, cardinal, deterministic: bool = True):
        ...
        dedh_dhai_graph = pynini.string_map(
            [("१" + NEMO_SPACE + MAI_ONE_HALF, MAI_DEDH), ("२" + NEMO_SPACE + MAI_ONE_HALF, MAI_DHAI)]
        )

        savva_numbers = cardinal_graph + pynini.cross(NEMO_SPACE + MAI_ONE_QUARTER, "")
        savva_graph = pynutil.insert(MAI_SAVVA) + pynutil.insert(NEMO_SPACE) + savva_numbers

        sadhe_numbers = cardinal_graph + pynini.cross(NEMO_SPACE + MAI_ONE_HALF, "")
        ...
        paune_numbers = paune + pynini.cross(NEMO_SPACE + MAI_THREE_QUARTERS, "")
