...
# Maithili digits: ०-९ (0-9) - Devanagari script
NEMO_MAI_DIGIT = pynini.union("०", "१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_MAI_NON_ZERO = pynini.union("१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_MAI_ZERO = "०"

# Maithili-specific fractional terms (natural Maithili pronunciation)
MAI_DEDH = "डेढ़"  # 1.5
MAI_DHAI = "ढाई"  # 2.5
MAI_SAVVA = "सवा"  # quarter more (1.25)
MAI_SADHE = "साढ़े"  # half more (X.5)
MAI_PAUNE = "पौने"  # quarter less (0.75)
