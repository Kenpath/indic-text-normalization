...
class WordFst(GraphFst):
    """
    Finite state transducer for classifying Magadhi words.
        e.g. मगही -> tokens { name: "मगही" }
    ...
    def __init__(self, punctuation: PunctuationFst, deterministic: bool = True):
        ...
        # Define Magadhi characters and symbols using pynini.union (Devanagari script)
        MAGADHI_CHAR = pynini.union(
        ...
        # Use MAGADHI_CHAR in the graph
        graph = pynini.closure(pynini.difference(MAGADHI_CHAR, symbols_to_exclude), 1)
