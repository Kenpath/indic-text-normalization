...
from indic_text_normalization.text_normalization.mag.graph_utils import NEMO_CHAR, NEMO_SIGMA, GraphFst, delete_space


class WordFst(GraphFst):
    """
    Finite state transducer for verbalizing Magadhi words.
        e.g. tokens { name: "मगही" } -> मगही
    ...
    def __init__(self, deterministic: bool = True):
        ...
        punct = pynini.union("!", "?", ".", ",", "-", ":", ";", "।")  # Magadhi punctuation marks
