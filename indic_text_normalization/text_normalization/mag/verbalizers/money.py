...
from indic_text_normalization.text_normalization.mag.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst


class MoneyFst(GraphFst):
    """
    Finite state transducer for verbalizing money, e.g.
        money { integer_part: "बारह" currency_maj: "रुपये" } -> बारह रुपये
        money { integer_part: "बारह" currency_maj: "रुपये" fractional_part: "पांच" currency_min: "centiles" } -> बारह रुपये पांच पैसे
        money { currency_maj: "रुपये" integer_part: "शून्य" fractional_part: "पांच" currency_min: "centiles" } -> पांच पैसे
