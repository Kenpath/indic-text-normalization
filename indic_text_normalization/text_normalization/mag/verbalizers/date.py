...
from indic_text_normalization.text_normalization.mag.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst, delete_space


class DateFst(GraphFst):
    """
    Finite state transducer for verbalizing date, e.g.
        date { day: "एक" month: "अप्रैल" year: "दुइ हज़ार चौबीस" } -> "एक अप्रैल दुइ हज़ार चौबीस"
        date { month: "अप्रैल" day: "एक" year: "दुइ हज़ार चौबीस" } -> "अप्रैल एक दुइ हज़ार चौबीस"
