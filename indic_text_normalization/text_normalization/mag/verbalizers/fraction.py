...
class FractionFst(GraphFst):
    ...
    Finite state transducer for verbalizing fraction
        e.g. fraction { integer: "तेईस" numerator: "चार" denominator: "छ" }-> तेईस चार बटा छ
        e.g. fraction { numerator: "चार" denominator: "छ" } -> चार बटा छ
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        # Magadhi words: "बटा" for "divided by" and "और" for "and"
