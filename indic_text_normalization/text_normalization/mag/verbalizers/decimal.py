...
from indic_text_normalization.text_normalization.mag.graph_utils import MINUS, NEMO_NOT_QUOTE, GraphFst, insert_space
from indic_text_normalization.text_normalization.mag.taggers.decimal import quantities


class DecimalFst(GraphFst):
    """
    Finite state transducer for verbalizing decimal, e.g.
        decimal { negative: "true" integer_part: "बारह"  fractional_part: "पांच शून्य शून्य छ" quantity: "अरब" } -> ऋण बारह दशमलव पांच शून्य शून्य छ अरब
        decimal { integer_part: "बारह" quantity: "अरब" } -> बारह अरब
    ...
    def __init__(self, deterministic: bool = True):
        ...
        # Use "दशमलव" (decimal point) in Magadhi
