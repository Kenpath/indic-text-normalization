...
class OrdinalFst(GraphFst):
    ...
    Finite state transducer for classifying Kannada ordinals, e.g.
        ೧೦ನೇ -> ordinal { integer: "ಹತ್ತನೇ" }
        ೨೧ನೇ -> ordinal { integer: "ಇಪ್ಪತ್ತೊಂದನೇ" }
    ...
    def __init__(self, cardinal: CardinalFst, deterministic: bool = True):
        ...
        from indic_text_normalization.text_normalization.kn.graph_utils import NEMO_KN_DIGIT, NEMO_DIGIT
        ...
        # Ordinals should only match when there's a clear suffix (like "ನೇ") after the number
