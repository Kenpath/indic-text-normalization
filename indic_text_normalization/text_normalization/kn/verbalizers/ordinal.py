...
from indic_text_normalization.text_normalization.kn.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space


class OrdinalFst(GraphFst):
    """
    Finite state transducer for verbalizing Kannada ordinals, e.g.
        ordinal { integer: "ಹತ್ತನೇ" } -> ಹತ್ತನೇ
        ordinal { integer: "ಇಪ್ಪತ್ತೊಂದನೇ" } -> ಇಪ್ಪತ್ತೊಂದನೇ
