...
class FractionFst(GraphFst):
    ...
    Finite state transducer for verbalizing fraction
        e.g. fraction { integer: "ಇಪ್ಪತ್ತಮೂರು" numerator: "ನಾಲ್ಕು" denominator: "ಆರು" }-> ಇಪ್ಪತ್ತಮೂರು ನಾಲ್ಕು ಬಿಟ್ಟು ಆರು
        e.g. fraction { numerator: "ನಾಲ್ಕು" denominator: "ಆರು" } -> ನಾಲ್ಕು ಬಿಟ್ಟು ಆರು
    ...
    def __init__(self, cardinal: GraphFst, deterministic: bool = True):
        ...
        insert_bata = pynutil.insert(" ಬಿಟ್ಟು ")
        insert_aur = pynutil.insert(" ಮತ್ತು ")
        graph_quarter = (
