...
from indic_text_normalization.text_normalization.kn.graph_utils import NEMO_NOT_QUOTE, GraphFst, delete_space, insert_space


class TimeFst(GraphFst):
    """
    Finite state transducer for verbalizing time, e.g.
        time { hours: "ಹನ್ನೆರಡು"  minutes: "ಹತ್ತು"  seconds: "ಹತ್ತು" } -> ಹನ್ನೆರಡು ಗಂಟೆಗೆ ಹತ್ತು ನಿಮಿಷ ಹತ್ತು ಸೆಕೆಂಡ್
        time { hours: "ಏಳು" minutes: "ನಲವತ್ತು"" } -> ಏಳು ಗಂಟೆಗೆ ನಲವತ್ತು ನಿಮಿಷ
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        insert_minute = pynutil.insert("ನಿಮಿಷ")
        insert_second = pynutil.insert("ಸೆಕೆಂಡ್")
        insert_bajkar = pynutil.insert("ಗಂಟೆಗೆ")
        insert_baje = pynutil.insert("ಗಂಟೆ")
