...
from indic_text_normalization.text_normalization.kn.graph_utils import NEMO_NOT_QUOTE, NEMO_SPACE, GraphFst


class MoneyFst(GraphFst):
    """
    Finite state transducer for verbalizing money, e.g.
        money { integer_part: "ಹನ್ನೆರಡು" currency_maj: "ರೂಪಾಯಿ" } -> ಹನ್ನೆರಡು ರೂಪಾಯಿ
        money { integer_part: "ಹನ್ನೆರಡು" currency_maj: "ರೂಪಾಯಿ" fractional_part: "ಐವತ್ತು" currency_min: "centiles" } -> ಹನ್ನೆರಡು ರೂಪಾಯಿ ಐವತ್ತು ಪೈಸೆ
