...
from indic_text_normalization.text_normalization.hi.graph_utils import (
    NEMO_SPACE,
    NEMO_WHITE_SPACE,
    GraphFst,
    delete_extra_space,
...
from indic_text_normalization.text_normalization.hi.taggers.abbreviation import AbbreviationFst
from indic_text_normalization.text_normalization.hi.taggers.cardinal import CardinalFst
from indic_text_normalization.text_normalization.hi.taggers.date import DateFst
from indic_text_normalization.text_normalization.hi.taggers.decimal import DecimalFst
from indic_text_normalization.text_normalization.hi.taggers.electronic import ElectronicFst
from indic_text_normalization.text_normalization.hi.taggers.fraction import FractionFst
from indic_text_normalization.text_normalization.hi.taggers.measure import MeasureFst
from indic_text_normalization.text_normalization.hi.taggers.money import MoneyFst
from indic_text_normalization.text_normalization.hi.taggers.ordinal import OrdinalFst
from indic_text_normalization.text_normalization.hi.taggers.punctuation import PunctuationFst
from indic_text_normalization.text_normalization.hi.taggers.range import RangeFst
from indic_text_normalization.text_normalization.hi.taggers.roman import RomanFst
from indic_text_normalization.text_normalization.hi.taggers.serial import SerialFst
from indic_text_normalization.text_normalization.hi.taggers.telephone import TelephoneFst
from indic_text_normalization.text_normalization.hi.taggers.time import TimeFst
from indic_text_normalization.text_normalization.hi.taggers.whitelist import WhiteListFst
from indic_text_normalization.text_normalization.hi.taggers.word import WordFst
from indic_text_normalization.text_normalization.hi.verbalizers.date import DateFst as vDateFst
from indic_text_normalization.text_normalization.hi.verbalizers.ordinal import OrdinalFst as vOrdinalFst
from indic_text_normalization.text_normalization.hi.verbalizers.time import TimeFst as vTimeFst
...
class ClassifyFst(GraphFst):
    ...
    def __init__(
        ...
        if not overwrite_cache and far_file and os.path.exists(far_file):
            ...
            start_time = time.time()
            from indic_text_normalization.text_normalization.hi.taggers.math import MathFst
