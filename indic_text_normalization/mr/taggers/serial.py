...
from indic_text_normalization.mr.utils import get_abs_path, load_labels
...
class SerialFst(GraphFst):
    ...
    def __init__(self, cardinal: GraphFst, ordinal: GraphFst, deterministic: bool = True, lm: bool = False):
        ...
        values with delimiters are handled by default).
            ...
            c325b -> tokens { cardinal { integer: "c तीन दोन पाच b" } }
        """
        if deterministic:
            # For Marathi, use final_graph for numbers
