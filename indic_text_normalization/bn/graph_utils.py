...
NEMO_BN_NON_ZERO = pynini.union("১", "২", "৩", "৪", "৫", "৬", "৭", "৮", "৯").optimize()
NEMO_BN_ZERO = "০"
...
# Bengali fraction words
BN_DEDH = "দেড়"  # 1.5 (one and a half)
BN_DHAI = "দুই সাড়ে"  # 2.5 (two and a half) - "দুই" means two, "সাড়ে" means half more
BN_SAVVA = "সাড়ে"  # quarter more (1.25) - "সাড়ে" can mean "half more" (X.5) or "quarter more" depending on context
BN_SADHE = "সাড়ে"  # half more (X.5) - "সাড়ে" means "half more than X"
BN_PAUNE = "পৌনে"  # quarter less (0.75 or three quarters) - "পৌনে" means "three quarters less than X"
