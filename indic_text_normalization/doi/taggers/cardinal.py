...
class CardinalFst(GraphFst):
    ...
    def __init__(self, deterministic: bool = True, lm: bool = False):
        ...
        # Add comma support: compose delete_commas with dogri_final_graph
        # This allows inputs like "1,000,001" or "१,००,००१" to be processed
        dogri_with_commas = pynini.compose(delete_commas, dogri_final_graph).optimize()
        
        # Give comma-separated numbers higher priority (lower weight)
        dogri_final_with_commas = pynutil.add_weight(dogri_with_commas, -0.1) | dogri_final_graph
        ...
        arabic_with_commas = pynini.compose(
            delete_commas,
            arabic_to_dogri_number @ dogri_final_graph
        ).optimize()
        ...
        # Combine both Dogri and Arabic digit paths (both with comma support)
        final_graph = dogri_final_with_commas | arabic_final_with_commas
