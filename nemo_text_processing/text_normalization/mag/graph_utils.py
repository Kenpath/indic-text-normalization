...
# Magadhi digits: ०-९ (0-9) - Devanagari script
NEMO_MAG_DIGIT = pynini.union("०", "१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_MAG_NON_ZERO = pynini.union("१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_MAG_ZERO = "०"
...
# Magadhi time-specific constants (authentic Magadhi vocabulary)
MAG_DEDH = "डेढ़"  # 1.5
MAG_DHAI = "ढाई"  # 2.5
MAG_SAVVA = "सवा"  # quarter more (1.25)
MAG_SADHE = "साढ़े"  # half more (X.5)
MAG_PAUNE = "पौने"  # quarter less (0.75)
