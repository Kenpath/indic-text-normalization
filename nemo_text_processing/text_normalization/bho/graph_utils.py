...
# Bhojpuri digits: ०-९ (0-9) - Devanagari script
NEMO_BHO_DIGIT = pynini.union("०", "१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_BHO_NON_ZERO = pynini.union("१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_BHO_ZERO = "०"
...
# Bhojpuri time-specific constants
BHO_DEDH = "डेढ़"  # 1.5
BHO_DHAI = "ढाई"  # 2.5
BHO_SAVVA = "सवा"  # quarter more (1.25)
BHO_SADHE = "साढ़े"  # half more (X.5)
BHO_PAUNE = "पौने"  # quarter less (0.75)
