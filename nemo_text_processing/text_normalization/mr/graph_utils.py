...
NEMO_MR_NON_ZERO = pynini.union("१", "२", "३", "४", "५", "६", "७", "८", "९").optimize()
NEMO_MR_ZERO = "०"

MR_DIDH = "ढीड"  # 1.5
MR_ADICH = "अढीच"  # 2.5 (Marathi: adich)
MR_SAVVA = "सव्वा"  # quarter more (1.25)
MR_SADHE = "साढ़े"  # half more (X.5)
MR_PAUNE = "पाऊने"  # quarter less (0.75)
...
MINUS = pynini.union(" वजा ", " वजावट ").optimize()
