...
from nemo_text_processing.text_normalization.bn.graph_utils import GraphFst, insert_space
...
class MoneyFst(GraphFst):
    ...
    Finite state transducer for classifying money, suppletive aware, e.g.
        ₹৫০ -> money { money { currency_maj: "টাকা" integer_part: "পঞ্চাশ" }
    ...
    def __init__(self, cardinal: GraphFst):
        ...
        currency_minor = pynutil.insert('currency_min: "') + pynutil.insert("পয়সা") + pynutil.insert('"')
