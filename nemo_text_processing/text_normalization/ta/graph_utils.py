...
MINUS = pynini.union(" கழித்தல் ", " கழித்தல் ").optimize()

# Tamil time-specific constants
TA_DEDH = "அரை"  # 1.5
TA_DHAI = "இரண்டரை"  # 2.5
TA_SAVVA = "கால்"  # quarter more (1.25)
TA_SADHE = "அரை"  # half more (X.5)
TA_PAUNE = "முக்கால்"  # quarter less (0.75)
